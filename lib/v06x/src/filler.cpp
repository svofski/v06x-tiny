...
{
    fill1_count += clocks;
    return fill0(clocks, commit_time, commit_time_pal, updateScreen);
...
IRAM_ATTR
int PixelFiller::fill0(int clocks, int commit_time, int commit_time_pal, bool updateScreen) {
...
auto PixelFiller::get_raster_pixel() const -> int
{
    return raster_pixel;
}
auto PixelFiller::get_raster_line() const -> int
{
    return raster_line;
}
